...
void RasterizerCitro3D::blit_render_targets_to_screen(int p_screen, const BlitToScreen *p_render_targets, int p_amount) {
...
void RasterizerCitro3D::_blit_render_target_to_screen(RID p_render_target, int p_screen, const Rect2 &p_screen_rect, uint32_t p_layer, bool p_first) {
	RendererCitro3D::RenderTarget *rt = RendererCitro3D::TextureStorage::get_singleton()->get_render_target(p_render_target);
	ERR_FAIL_COND(!rt);
	if (p_screen == 0) {
